"""
Django settings for {{ cookiecutter.python_slug }} project.
...
LOG_LEVEL = os.environ.get("{{ cookiecutter.python_slug }}_LOG_LEVEL", "DEBUG")
...
ROOT_URLCONF = "{{ cookiecutter.python_slug }}.urls"
...
WSGI_APPLICATION = "{{ cookiecutter.python_slug }}.wsgi.application"
...
STATIC_ROOT = BASE_DIR / "{{ cookiecutter.python_slug }}/static"
